...
public class MP4TrackInfo {
  ...
  public MP4TrackInfo(
      ...
      int width,
      int height,
      double audioTimeScale,
      int audioChannels,
      int audioCodecType,
      long audioSampleSize,
      int[] audioSamples,
      long[] audioChunkOffsets,
      long audioSampleDuration,
      double videoTimeScale,
      int videoSampleCount,
      double fps,
      int[] videoSamples,
      long[] videoChunkOffsets,
      long videoSampleDuration,
      int avcLevel,
      int avcProfile,
      List<CompositionOffsetsBox.Entry> compositionTimes,
      SampleToChunkBox.SampleToChunkEntry[] audioSamplesToChunks,
      SampleToChunkBox.SampleToChunkEntry[] videoSamplesToChunks,
      int[] syncSamples,
      Map<Integer, Long> timePosMap,
      Map<Integer, Long> samplePosMap) {
  ...
  /**
   * Detects the type of AAC (or possibly MP3) based on the first byte in the audioDecoderBytes
   * buffer.
   */
