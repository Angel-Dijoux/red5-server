...
public class MP4Parser {
  ...
  private void decodeMediaBox(
      MediaBox mdia, AtomicInteger scale, AtomicBoolean isAudio, AtomicBoolean isVideo) {
  ...
  private void decodeMediaInfoBox(
      MediaInfoBox minf, AtomicBoolean isAudio, AtomicBoolean isVideo, int scale) {
