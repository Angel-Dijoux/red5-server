...
public class ProviderService implements IProviderService {
  ...
  /** {@inheritDoc} */
  public InputKind lookupProviderInput(IScope scope, String name, int type) {
    InputKind result = InputKind.NOT_FOUND;
